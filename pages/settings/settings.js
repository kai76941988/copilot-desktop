...
var lowMemoryModeCheckbox = document.getElementById('checkbox-low-memory-mode')
var longArticleModeCheckbox = document.getElementById('checkbox-long-article-mode')
var gpuAccelCheckbox = document.getElementById('checkbox-gpu-accel')
...
settings.get('lowMemoryMode', function (value) {
  lowMemoryModeCheckbox.checked = (value === true)
})

lowMemoryModeCheckbox.addEventListener('change', function () {
  settings.set('lowMemoryMode', this.checked)
  showRestartRequiredBanner()
})

settings.get('longArticleMode', function (value) {
  longArticleModeCheckbox.checked = (value !== false)
})

longArticleModeCheckbox.addEventListener('change', function () {
  settings.set('longArticleMode', this.checked)
})

settings.get('gpuAccelerationEnabled', function (value) {
  gpuAccelCheckbox.checked = (value !== false)
})

gpuAccelCheckbox.addEventListener('change', function () {
  settings.set('gpuAccelerationEnabled', this.checked)
  showRestartRequiredBanner()
})
