...
- 🔗 **MCP Support**: Built-in MCP server for AI assistants to control the browser directly
...
This application includes a built-in MCP server, allowing AI assistants (Claude, Cursor, Windsurf) to control the browser directly.

### Configuration

By default, the MCP server runs at `http://127.0.0.1:3000`. You can modify the configuration in `pake.json`:
...
Add the following configuration to your AI tool's config file:
...
**Cursor / Windsurf**:
Add MCP server in settings: `http://127.0.0.1:3000/sse`
...
| `browser_notification` | Send notification |
| `browser_show` | Show window |
| `browser_hide` | Hide window |

### Available Resources

| Resource URI | Description |
|--------------|-------------|
| `browser://current-url` | Current page URL |
| `browser://title` | Page title |
| `browser://content` | Page HTML content |
| `browser://text` | Visible page text |
| `browser://window-state` | Window state |
